...
class TwitterListener(StreamListener):
    ...
    def on_error(self, status):
        if status == 420:   #excessive request error 
...
def main(a):
        ...
        tweets = api.user_timeline(screen_name=a, count=100)
        ...
        print("Avg.Length:" + str(np.mean(df['len'])))
        ...
        time_favs.plot(figsize=(16, 4), color='g')
        plt.ylabel('likes')
        plt.show()
